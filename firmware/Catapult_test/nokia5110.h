...
class Nokia5110
{
    static unsigned char ASCII[96][5];
private:
    static void Write(byte dc, byte data);
public:
    static void Clear(void);
    static void Initialise(void);
    static void PrintCharacter(char character);
    static void PrintString(char *characters);
    static void gotoXY(int x, int y);
};

//typedef unsigned char byte;

byte Nokia5110::ASCII[96][5] =
{
...
void Nokia5110::Initialise(void)
{
    ...
    Write(LCD_C, 0xBc );  // Set LCD Vop (Contrast). 
...
void Nokia5110::PrintCharacter(char character)
{
    Write(LCD_D, 0x00);
...
void Nokia5110::PrintString(char *characters)
{
    while (*characters)
    {
